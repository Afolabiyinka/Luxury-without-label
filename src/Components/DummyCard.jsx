...
export default function DummyCard() {
  return (
    <Card className="transition-all duration-75 animate-pulse flex flex-col rounded-2xl overflow-hidden shadow-md hover:shadow-xl  w-[100%] ">
      {/* Product Image */}
      ...
      <div className="flex flex-col justify-between p-4">
        <p className="text-lg font-semibold bg-gray-300 rounded-lg h-3 w-80 line-clamp-2 transition-all duration-300 animate-pulse "></p>

        <span className="flex justify-between p-2 items-center">
          <p className="w-32 rounded-lg bg-gray-300 h-3 transition-all duration-300 animate-pulse "></p>
          <button
