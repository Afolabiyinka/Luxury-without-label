...
export default function BlogCard({ blog }) {
  ...
  return (
    <Card className="flex h-fit w-full max-w-[48rem] flex-col gap-1 p-1 md:flex-row overflow-hidden shadow-lg hover:opacity-75 cursor-pointer transition-all duration-300 justify-center items-center">
