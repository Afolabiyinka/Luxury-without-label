    ...
    <div className="min-h-screen py-16 px-4 flex flex-col items-center">
      <div className="max-w-3xl w-full">
          ...
          >
            ...
            >
              <Accordion.Trigger className="px-6 py-5 flex justify-between items-center w-full hover:bg-gray-50 transition-all duration-200 group">
                ...
                <ChevronDown className="h-5 w-5 text-indigo-500 transition-transform duration-300 ease-in-out group-data-[open=true]:rotate-180" />
              </Accordion.Trigger>
        ...
        <div className="mt-10 text-center">
          ...
          <button className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-full hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            Contact Support
          </button>
        </div>
      </div>
